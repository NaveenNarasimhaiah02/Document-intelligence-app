class DocumentModel {
  ...
  DocumentModel({required this.id, required this.imagePath, required this.type,
      ...
      required this.documentNumber, required this.amount, this.checksum});

  Map<String, dynamic> toMap() => {
    'id': id, 'imagePath': imagePath, 'type': type, 'date': date,
    'personName': personName, 'providerName': providerName,
    'documentNumber': documentNumber, 'amount': amount, 'checksum': checksum
  };
